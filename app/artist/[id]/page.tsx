  ...
  return (
    <main className="min-h-screen bg-white text-gray-900 flex flex-col items-center py-12 px-6">
      ...
      <div className="w-full max-w-sm mb-12">
        <Link
          href="/"
          className="inline-flex items-center text-gray-500 hover:text-black transition-all duration-200 active:scale-95 active:bg-gray-100 rounded-lg px-3 py-2 -ml-3 mb-6"
        >
          {/* 1. 左矢印アイコン（視覚的なガイド） */}
          <svg
